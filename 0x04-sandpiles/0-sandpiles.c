...
/**
 * sum_grids - compute the sum of two sandpiles
 * @grid1: sandpiles
 * @grid2: sandpiles
 * Return: void
 */
...
/**
 * check_grids - compute the sum of two sandpiles
 * @grid1: sandpile
 * Return: void 
 */
...
/**
 * print_grid - compute the sum of two sandpiles
 * @grid: sandpile
 * Return: void 
 */
...
/**
 * change_grids - compute the sum of two sandpiles
 * @grid1: sandpile
 * Return: void
 */
